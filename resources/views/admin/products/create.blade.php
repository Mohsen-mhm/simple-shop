...
@section('content')
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" class="max-w-md mx-auto"
        ...
        <div class="w-full mb-5">
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">عکس
                محصول</label>
            <input name="image" required value="{{ old('image') }}"
        ...
        <div>
            ...
            <div class="w-full flex justify-center items-center flex-wrap gap-3">
                ...
                <div class="flex items-center me-4">
                    <input id="black-checkbox" type="checkbox" name="colors[]" value="gray"
